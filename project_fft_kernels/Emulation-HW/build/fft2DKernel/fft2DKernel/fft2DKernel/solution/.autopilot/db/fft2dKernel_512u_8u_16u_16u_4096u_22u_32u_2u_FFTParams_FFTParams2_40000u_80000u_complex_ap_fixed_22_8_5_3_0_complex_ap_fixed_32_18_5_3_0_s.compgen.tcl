...
# FIFO definition: 
set ID 1827
set FifoName fft2DKernel_fifo_w64_d3_S
set InstName p_fftOutData_c_channel_U
...
# FIFO definition: 
set ID 1828
set FifoName fft2DKernel_fifo_w512_d16_A
set InstName fftInStrm_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 16
...
# FIFO definition: 
set ID 1829
set FifoName fft2DKernel_fifo_w32_d2_S
set InstName n_images_c8_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
# FIFO definition: 
set ID 1832
set FifoName fft2DKernel_start_for_fft2dKernel_512u_8u_16u_16u_4096u_22u_32u_2u_FFTParams_FFTParams2_4b1s
set InstName start_for_fft2dKernel_512u_8u_16u_16u_4096u_22u_32u_2u_FFTParams_FFTParams2_4b1s_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_fftInData { I 64 vector } p_fftInData_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_fftOutData { I 64 vector } p_fftOutData_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { n_images { I 32 vector } n_images_ap_vld { I 1 bit } } \
} "
}
