...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_fftInData \
    op interface \
    ports { p_fftInData { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fftInStrm_din { O 512 vector } fftInStrm_full_n { I 1 bit } fftInStrm_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_n_images \
    op interface \
    ports { n_images { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_n_images_c8 \
    op interface \
    ports { n_images_c8_din { O 32 vector } n_images_c8_full_n { I 1 bit } n_images_c8_write { O 1 bit } } \
} "
}
