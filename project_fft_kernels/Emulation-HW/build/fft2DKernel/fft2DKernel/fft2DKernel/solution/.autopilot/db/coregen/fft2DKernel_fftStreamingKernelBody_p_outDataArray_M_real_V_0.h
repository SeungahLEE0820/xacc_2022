...
#ifndef _fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_H_
#define _fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore.h"

SC_MODULE(fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0) {
...
protected:
    ...
    fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore* fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U;
...
public:
    ~fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0();
    SC_CTOR(fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U = new fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore("fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U");
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->clk      ( clk );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->reset    ( reset );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->ce0      ( i_ce0 );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->we0      ( i_we0 );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->address0 ( memcore_iaddr );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->d0       ( i_d0 );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->q0       ( i_q0 );

        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->ce1      ( t_ce0 );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->we1      ( t_we0 );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->address1 ( memcore_taddr );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->d1       ( t_d0 );
        fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "fft2DKernel_fftStreamingKernelBody_p_outDataArray_M_real_V_0.trace");
            // ports
