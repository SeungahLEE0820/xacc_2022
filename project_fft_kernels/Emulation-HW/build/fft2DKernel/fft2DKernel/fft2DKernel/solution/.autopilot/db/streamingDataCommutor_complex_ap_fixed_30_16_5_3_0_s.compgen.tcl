...
set id 1045
set name fft2DKernel_mux_42_30_1_1
...
set ID 1058
set hasByteEnable 0
set MemName fft2DKernel_streamingDataCommutor_complex_ap_fixed_30_16_5_3_0_s_delayline_Array_1
...
set ID 1059
set hasByteEnable 0
set MemName fft2DKernel_streamingDataCommutor_complex_ap_fixed_30_16_5_3_0_s_delayline_Array_11
set CoreName ShiftReg
set PortList { 2 }
set DataWd 61
set AddrRange 2
...
set ID 1060
set hasByteEnable 0
set MemName fft2DKernel_streamingDataCommutor_complex_ap_fixed_30_16_5_3_0_s_delayline_Array_36
set CoreName ShiftReg
set PortList { 2 }
set DataWd 61
set AddrRange 1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fftOutData_local2_din { O 256 vector } fftOutData_local2_full_n { I 1 bit } fftOutData_local2_write { O 1 bit } } \
} "
}
