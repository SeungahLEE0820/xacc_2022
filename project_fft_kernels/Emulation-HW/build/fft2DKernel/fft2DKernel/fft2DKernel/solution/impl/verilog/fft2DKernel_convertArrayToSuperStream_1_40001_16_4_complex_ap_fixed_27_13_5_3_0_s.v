...
module fft2DKernel_convertArrayToSuperStream_1_40001_16_4_complex_ap_fixed_27_13_5_3_0_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [1:0] i45_reg_190;
wire   [1:0] i_fu_216_p2;
reg   [1:0] i_reg_309;
reg   [0:0] icmp_ln127_reg_314;
reg    ap_block_state1;
reg    ap_block_pp0_stage0_subdone;
reg   [1:0] ap_phi_mux_i45_phi_fu_194_p6;
wire   [63:0] zext_ln127_fu_204_p1;
reg    ap_block_pp0_stage0_01001;
wire   [250:0] tmp_fu_228_p16;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln127_reg_314 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln127_reg_314 == 1'd0))) begin
        i45_reg_190 <= i_reg_309;
    end else if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln127_reg_314 == 1'd1)) | (~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
        i45_reg_190 <= 2'd0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln127_reg_314 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_106)) begin
        if ((icmp_ln127_reg_314 == 1'd1)) begin
            ap_phi_mux_i45_phi_fu_194_p6 = 2'd0;
        end else if ((icmp_ln127_reg_314 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln127_fu_222_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign i_fu_216_p2 = (ap_phi_mux_i45_phi_fu_194_p6 + 2'd1);

assign icmp_ln127_fu_222_p2 = ((ap_phi_mux_i45_phi_fu_194_p6 == 2'd3) ? 1'b1 : 1'b0);

assign p_inDataArray_M_imag4_address0 = zext_ln127_fu_204_p1;

assign p_inDataArray_M_imag5_address0 = zext_ln127_fu_204_p1;

assign p_inDataArray_M_imag6_address0 = zext_ln127_fu_204_p1;

assign p_inDataArray_M_imag_address0 = zext_ln127_fu_204_p1;

assign p_inDataArray_M_real1_address0 = zext_ln127_fu_204_p1;

assign p_inDataArray_M_real2_address0 = zext_ln127_fu_204_p1;

assign p_inDataArray_M_real3_address0 = zext_ln127_fu_204_p1;

assign p_inDataArray_M_real_address0 = zext_ln127_fu_204_p1;

assign ssrWideStream4kernelOut_din = tmp_fu_228_p16;

assign tmp_fu_228_p16 = {{{{{{{{{{{{{{{p_inDataArray_M_imag6_q0}, {5'd0}}, {p_inDataArray_M_real3_q0}}, {5'd0}}, {p_inDataArray_M_imag5_q0}}, {5'd0}}, {p_inDataArray_M_real2_q0}}, {5'd0}}, {p_inDataArray_M_imag4_q0}}, {5'd0}}, {p_inDataArray_M_real1_q0}}, {5'd0}}, {p_inDataArray_M_imag_q0}}, {5'd0}}, {p_inDataArray_M_real_q0}};

assign zext_ln127_fu_204_p1 = ap_phi_mux_i45_phi_fu_194_p6;

endmodule //fft2DKernel_convertArrayToSuperStream_1_40001_16_4_complex_ap_fixed_27_13_5_3_0_s
