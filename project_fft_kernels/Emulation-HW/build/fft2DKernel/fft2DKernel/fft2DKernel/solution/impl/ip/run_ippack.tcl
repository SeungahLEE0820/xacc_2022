...
set Library     "hls"
set IPName      "fft2DKernel"
set Version     "1.0"
set DisplayName "Fft2dkernel"
set Revision    "2112350572"
...
set xo_kernel_name "fft2DKernel"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/centos/workspace/project_fft_kernels/Emulation-HW/build/fft2DKernel/fft2DKernel/fft2DKernel/solution"
set debug_dir "/home/centos/workspace/project_fft_kernels/Emulation-HW/build/fft2DKernel/fft2DKernel/fft2DKernel/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {fft2DKernel_flow_control_loop_pipe_sequential_init
...
fft2DKernel_flow_control_loop_pipe
...
fft2DKernel_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 p_fftInData_1 W 0x0 "Data signal of p_fftInData" {{0 32 p_fftInData W 0 "Bit 31 to 0 of p_fftInData"}}} {0x14 p_fftInData_2 W 0x0 "Data signal of p_fftInData" {{0 32 p_fftInData W 0 "Bit 63 to 32 of p_fftInData"}}} {0x1c p_fftOutData_1 W 0x0 "Data signal of p_fftOutData" {{0 32 p_fftOutData W 0 "Bit 31 to 0 of p_fftOutData"}}} {0x20 p_fftOutData_2 W 0x0 "Data signal of p_fftOutData" {{0 32 p_fftOutData W 0 "Bit 63 to 32 of p_fftOutData"}}} {0x28 n_images W 0x0 "Data signal of n_images" {{0 32 n_images W 0 "Bit 31 to 0 of n_images"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
