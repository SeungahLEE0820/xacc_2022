...
module fft2DKernel_fftStreamingKernelBody_Loop_VITIS_LOOP_3276_1_proc262 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [2:0] select_ln3276_3_fu_340_p3;
...
wire   [2:0] add_ln3276_3_fu_334_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_220)) begin
        i_fu_86 <= select_ln3276_3_fu_340_p3;
    end
end
...
assign add_ln3276_3_fu_334_p2 = (ap_sig_allocacmp_i_load + 3'd1);
...
assign select_ln3276_3_fu_340_p3 = ((icmp_ln3277_reg_429[0:0] == 1'b1) ? add_ln3276_3_fu_334_p2 : ap_sig_allocacmp_i_load);
...
assign zext_ln3276_fu_347_p1 = select_ln3276_3_fu_340_p3;

endmodule //fft2DKernel_fftStreamingKernelBody_Loop_VITIS_LOOP_3276_1_proc262
