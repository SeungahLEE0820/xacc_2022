...
`timescale 1ps/1ps
module fft2DKernel_invTranspWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_27_13_5_3_0_s_l_memWPgM_ram # (

  // Common module parameters
  parameter integer                 MEMORY_SIZE        = 108,
...
endmodule : fft2DKernel_invTranspWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_27_13_5_3_0_s_l_memWPgM_ram
`timescale 1 ns / 1 ps
module fft2DKernel_invTranspWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_27_13_5_3_0_s_l_memWPgM(
    reset,
    clk,
    address0,
    ce0,
...
fft2DKernel_invTranspWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_27_13_5_3_0_s_l_memWPgM_ram fft2DKernel_invTranspWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_27_13_5_3_0_s_l_memWPgM_ram_U(
    .clka( clk ),
    .rsta( reset ),
    .addra( address0 ),
    .ena( ce0 ),
