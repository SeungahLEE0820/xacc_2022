...
entity fft2DKernel_fftStreamingKernelBody_Loop_VITIS_LOOP_3276_1_proc262 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft2DKernel_fftStreamingKernelBody_Loop_VITIS_LOOP_3276_1_proc262 is 
...
attribute shreg_extract : string;
    ...
    signal select_ln3276_3_fu_340_p3 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal add_ln3276_3_fu_334_p2 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    add_ln3276_3_fu_334_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv3_1));
    ...
    select_ln3276_3_fu_340_p3 <= 
        add_ln3276_3_fu_334_p2 when (icmp_ln3277_reg_429(0) = '1') else 
    ...
    zext_ln3276_fu_347_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln3276_3_fu_340_p3),64));
end behav;
