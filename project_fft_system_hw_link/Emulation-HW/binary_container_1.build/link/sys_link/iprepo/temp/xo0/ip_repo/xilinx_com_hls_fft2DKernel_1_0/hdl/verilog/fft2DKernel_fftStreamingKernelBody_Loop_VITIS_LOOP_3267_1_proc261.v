...
module fft2DKernel_fftStreamingKernelBody_Loop_VITIS_LOOP_3267_1_proc261 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_227)) begin
        if ((icmp_ln3267_fu_258_p2 == 1'd0)) begin
            i_fu_88 <= select_ln3267_3_fu_296_p3;
...
assign add_ln3267_3_fu_290_p2 = (ap_sig_allocacmp_i_load + 3'd1);
...
assign select_ln3267_3_fu_296_p3 = ((icmp_ln3268_fu_276_p2[0:0] == 1'b1) ? add_ln3267_3_fu_290_p2 : ap_sig_allocacmp_i_load);
...
assign zext_ln3267_fu_304_p1 = select_ln3267_3_fu_296_p3;

endmodule //fft2DKernel_fftStreamingKernelBody_Loop_VITIS_LOOP_3267_1_proc261
