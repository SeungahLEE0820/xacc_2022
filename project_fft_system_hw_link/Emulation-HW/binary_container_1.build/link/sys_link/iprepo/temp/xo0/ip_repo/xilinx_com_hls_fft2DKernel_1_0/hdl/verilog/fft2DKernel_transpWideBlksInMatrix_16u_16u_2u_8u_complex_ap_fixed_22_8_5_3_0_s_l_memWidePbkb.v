...
`timescale 1ps/1ps
module fft2DKernel_transpWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_22_8_5_3_0_s_l_memWidePbkb_ram # (

  // Common module parameters
  parameter integer                 MEMORY_SIZE        = 88,
  ...
  parameter integer                 WRITE_DATA_WIDTH_A = 22,
...
endmodule : fft2DKernel_transpWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_22_8_5_3_0_s_l_memWidePbkb_ram
`timescale 1 ns / 1 ps
module fft2DKernel_transpWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_22_8_5_3_0_s_l_memWidePbkb(
    reset,
    clk,
    address0,
    ce0,
...
fft2DKernel_transpWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_22_8_5_3_0_s_l_memWidePbkb_ram fft2DKernel_transpWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_22_8_5_3_0_s_l_memWidePbkb_ram_U(
    .clka( clk ),
    .rsta( reset ),
    .addra( address0 ),
    .ena( ce0 ),
