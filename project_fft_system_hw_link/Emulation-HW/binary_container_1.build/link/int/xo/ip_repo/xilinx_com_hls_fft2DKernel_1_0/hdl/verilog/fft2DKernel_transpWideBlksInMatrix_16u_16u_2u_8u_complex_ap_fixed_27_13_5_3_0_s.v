...
module fft2DKernel_transpWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_27_13_5_3_0_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        start_out,
        start_write,
        l_transpMatrixStream_dout,
        l_transpMatrixStream_empty_n,
        l_transpMatrixStream_read,
        l_transpBlkMatrixStream2_din,
        l_transpBlkMatrixStream2_full_n,
        l_transpBlkMatrixStream2_write,
        ap_ext_blocking_n,
        ap_str_blocking_n,
        ap_int_blocking_n
);
...
output   start_out;
output   start_write;
input  [511:0] l_transpMatrixStream_dout;
input   l_transpMatrixStream_empty_n;
output   l_transpMatrixStream_read;
output  [511:0] l_transpBlkMatrixStream2_din;
input   l_transpBlkMatrixStream2_full_n;
output   l_transpBlkMatrixStream2_write;
...
reg ap_idle;
reg start_write;
reg l_transpMatrixStream_read;
reg l_transpBlkMatrixStream2_write;
...
wire   [1:0] add_ln76_1_fu_867_p2;
wire   [0:0] icmp_ln77_fu_873_p2;
wire   [1:0] add_ln76_fu_879_p2;
wire   [1:0] c_1_fu_899_p3;
reg   [1:0] c_1_reg_1079;
...
wire   [1:0] r_16_fu_939_p2;
reg   [1:0] r_16_reg_1164;
wire   [1:0] add_ln89_1_fu_945_p2;
reg   [1:0] add_ln89_1_reg_1169;
...
reg   [1:0] ap_phi_mux_r_15200_phi_fu_608_p4;
...
always @ (posedge ap_clk) begin
    if (((l_transpMatrixStream_empty_n == 1'b1) & (icmp_ln76_fu_885_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((l_transpMatrixStream_empty_n == 1'b0)) begin
...
always @ (*) begin
    if ((((l_transpMatrixStream_empty_n == 1'b1) & (1'b1 == ap_CS_fsm_state3)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter2 == 1'b1)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1)))) begin
...
always @ (*) begin
    if (((l_transpMatrixStream_empty_n == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
        ...
        l_transpBlkMatrixStream2_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
        l_transpBlkMatrixStream2_write = 1'b1;
    end else begin
        l_transpBlkMatrixStream2_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((l_transpMatrixStream_empty_n == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        l_transpMatrixStream_read = 1'b1;
    end else begin
        l_transpMatrixStream_read = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((l_transpMatrixStream_empty_n == 1'b1) & (icmp_ln76_fu_885_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else if (((l_transpMatrixStream_empty_n == 1'b1) & (icmp_ln76_fu_885_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign add_ln76_1_fu_867_p2 = (indvar_flatten203_reg_571 + 2'd1);

assign add_ln76_fu_879_p2 = (r_fu_651_p3 + 2'd1);

assign add_ln81_fu_835_p2 = (select_ln76_fu_643_p3 + shl_ln76_fu_659_p2);

assign add_ln89_1_fu_945_p2 = (ap_phi_mux_indvar_flatten7198_phi_fu_630_p4 + 2'd1);

assign add_ln89_fu_957_p2 = (c_1_fu_899_p3 + 2'd1);

assign add_ln92_fu_913_p2 = (shl_ln92_fu_907_p2 + c_1_fu_899_p3);
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter2 == 1'b1) & (l_transpBlkMatrixStream2_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter2 == 1'b1) & (l_transpBlkMatrixStream2_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter2 == 1'b1) & (l_transpBlkMatrixStream2_full_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state7_pp1_stage0_iter2 = (l_transpBlkMatrixStream2_full_n == 1'b0);
end
...
assign ap_int_blocking_cur_n = (l_transpMatrixStream_blk_n & l_transpBlkMatrixStream2_blk_n);
...
assign c_1_fu_899_p3 = ((ap_phi_mux_icmp_ln90201_phi_fu_597_p4[0:0] == 1'b1) ? ap_phi_mux_add_ln89202_phi_fu_586_p4 : ap_phi_mux_c199_phi_fu_619_p4);
...
assign icmp_ln90_fu_951_p2 = ((r_16_fu_939_p2 == 2'd2) ? 1'b1 : 1'b0);

assign l_memWidePipoBuff_superSample_M_imag_V_0_d0 = {{l_transpMatrixStream_dout[58:32]}};

assign l_memWidePipoBuff_superSample_M_imag_V_1_d0 = {{l_transpMatrixStream_dout[122:96]}};

assign l_memWidePipoBuff_superSample_M_imag_V_2_d0 = {{l_transpMatrixStream_dout[186:160]}};

assign l_memWidePipoBuff_superSample_M_imag_V_3_d0 = {{l_transpMatrixStream_dout[250:224]}};

assign l_memWidePipoBuff_superSample_M_imag_V_4_d0 = {{l_transpMatrixStream_dout[314:288]}};

assign l_memWidePipoBuff_superSample_M_imag_V_5_d0 = {{l_transpMatrixStream_dout[378:352]}};

assign l_memWidePipoBuff_superSample_M_imag_V_6_d0 = {{l_transpMatrixStream_dout[442:416]}};

assign l_memWidePipoBuff_superSample_M_imag_V_7_d0 = {{l_transpMatrixStream_dout[506:480]}};

assign l_memWidePipoBuff_superSample_M_real_V_0_d0 = l_transpMatrixStream_dout[26:0];

assign l_memWidePipoBuff_superSample_M_real_V_1_d0 = {{l_transpMatrixStream_dout[90:64]}};

assign l_memWidePipoBuff_superSample_M_real_V_2_d0 = {{l_transpMatrixStream_dout[154:128]}};

assign l_memWidePipoBuff_superSample_M_real_V_3_d0 = {{l_transpMatrixStream_dout[218:192]}};

assign l_memWidePipoBuff_superSample_M_real_V_4_d0 = {{l_transpMatrixStream_dout[282:256]}};

assign l_memWidePipoBuff_superSample_M_real_V_5_d0 = {{l_transpMatrixStream_dout[346:320]}};

assign l_memWidePipoBuff_superSample_M_real_V_6_d0 = {{l_transpMatrixStream_dout[410:384]}};

assign l_memWidePipoBuff_superSample_M_real_V_7_d0 = {{l_transpMatrixStream_dout[474:448]}};

assign l_transpBlkMatrixStream2_din = tmp_fu_969_p32;

assign r_16_fu_939_p2 = (select_ln89_fu_891_p3 + 2'd1);

assign r_fu_651_p3 = ((icmp_ln77206_reg_538[0:0] == 1'b1) ? add_ln76207_reg_527 : r204_reg_560);

assign select_ln76_fu_643_p3 = ((icmp_ln77206_reg_538[0:0] == 1'b1) ? 2'd0 : c_1205_reg_549);

assign select_ln89_fu_891_p3 = ((ap_phi_mux_icmp_ln90201_phi_fu_597_p4[0:0] == 1'b1) ? 2'd0 : ap_phi_mux_r_15200_phi_fu_608_p4);
...
endmodule //fft2DKernel_transpWideBlksInMatrix_16u_16u_2u_8u_complex_ap_fixed_27_13_5_3_0_s
