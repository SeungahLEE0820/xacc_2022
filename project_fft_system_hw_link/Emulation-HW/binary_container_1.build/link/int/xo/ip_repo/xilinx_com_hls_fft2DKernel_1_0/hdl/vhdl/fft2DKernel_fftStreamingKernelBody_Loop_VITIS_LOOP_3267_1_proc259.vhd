...
entity fft2DKernel_fftStreamingKernelBody_Loop_VITIS_LOOP_3267_1_proc259 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft2DKernel_fftStreamingKernelBody_Loop_VITIS_LOOP_3267_1_proc259 is 
...
attribute shreg_extract : string;
    ...
    signal select_ln3267_4_fu_296_p3 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal add_ln3267_4_fu_290_p2 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    mux_42_22_1_1_U76 : component fft2DKernel_mux_42_22_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 22,
    ...
    mux_42_22_1_1_U77 : component fft2DKernel_mux_42_22_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 22,
    ...
    add_ln3267_4_fu_290_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv3_1));
    ...
    select_ln3267_4_fu_296_p3 <= 
        add_ln3267_4_fu_290_p2 when (icmp_ln3268_fu_276_p2(0) = '1') else 
    ...
    zext_ln3267_fu_304_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln3267_4_fu_296_p3),64));
end behav;
