...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /fft2DKernel_1/ap_rst_n] \
...
sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /fft2DKernel_1/m_axi_gmem] \
